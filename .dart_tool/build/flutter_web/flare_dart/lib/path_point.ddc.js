define(['dart_sdk', 'packages/flare_dart/math/mat2d', 'packages/flare_dart/binary_reader'], function(dart_sdk, packages__flare_dart__math__mat2d, packages__flare_dart__binary_reader) {
  ...
  var HashMapOfint$PointType = () => (HashMapOfint$PointType = dart.constFn(collection.HashMap$(core.int, path_point.PointType)))();
  var JSArrayOfint = () => (JSArrayOfint = dart.constFn(_interceptors.JSArray$(core.int)))();
  var JSArrayOfPointType = () => (JSArrayOfPointType = dart.constFn(_interceptors.JSArray$(path_point.PointType)))();
